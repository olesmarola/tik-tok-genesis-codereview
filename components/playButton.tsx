...
const PlayButton: FC<PlayButtonProps> = ({ onClick, isPaused }) => {
  return (
    <Button onClick={onClick}>
      {isPaused ? (
        <Svg data-testid="play_button_play" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494.148 494.148" xmlSpace="preserve">
        ...
        <Svg data-testid="play_button_pause" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.607 47.607" xmlSpace="preserve">
